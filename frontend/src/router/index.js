      ...
      children: [
        {
          ...
          meta: { title: 'Dashboard', subtitle: 'Tổng quan hoạt động workspace và task' },
        },
        {
          path: 'workspaces',
          name: 'workspaces',
        ...
        },
        {
          ...
          meta: { title: 'Task', subtitle: 'Theo dõi task theo từng workspace và xử lý ngay trên danh sách' },
        },
        {
          path: 'profile',
          name: 'profile',
          component: ProfileView,
          meta: { title: 'Profile', subtitle: 'Cập nhật email và đổi mật khẩu của bạn' },
        },
      ],
    },
  ],
